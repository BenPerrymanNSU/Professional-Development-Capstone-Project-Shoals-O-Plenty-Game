...
public class BoatFunctionScript : MonoBehaviour
{
    ...
    public PlayerNeedStats playerNS;
    ...
    private int materialButtonListSize = 3;
    private string[] materialNames = {"WoodPlank", "Rope", "Rock"};

    public void Awake(){
        materialButtons = new List<Button>(materialButtonListSize);
        materialButtons.Add(woodButton);
        materialButtons.Add(ropeButton);
        materialButtons.Add(rockButton);
    ...
    public void MaterialButtonPressed(bool called){
        ...
        for(int i = 0; i < 3; i++){
            if(materialButtonString == materialButtons[i].ToString().Split()[0]){
    ...
    public void IncreaseBoatLevel(){
        ...
        if(level3Boat == true){
            if(woodNeeded == 0 && ropeNeeded == 0 && rockNeeded == 0){
                playerNS.Hunger = 100f;
                playerNS.hungerBar.value = 100f;
                playerNS.Thirst = 100f;
                playerNS.thirstBar.value = 100f;
                playerNS.Rest = 100f;
                playerNS.restBar.value = 100f;
